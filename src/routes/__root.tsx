...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      // Fontes self-hosted: sem round-trip para fonts.googleapis.com (FCP/CLS)
      {
        rel: "preload",
        as: "font",
        type: "font/woff2",
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              ...
              // O fbevents.js é carregado logo após o primeiro paint e processa a fila
              // inteira — nenhum evento é perdido, apenas sai do caminho crítico do LCP.
              var loaded=!1;
              function load(){
              ...
              if(f.requestIdleCallback){f.requestIdleCallback(load,{timeout:2500});}
              else{f.setTimeout(load,1200);}
              f.addEventListener('load',function(){f.setTimeout(load,300);});
